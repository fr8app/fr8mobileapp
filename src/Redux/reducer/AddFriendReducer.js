...
function addFriend(state = initialState, action) {
  switch (action.type) {
    case ApiConstants.constants.API_ADD_FRIEND_LOAD:
    ...
    case ApiConstants.constants.API_ADD_FRIEND_UNAUTHENTICATED:
    ...
    case ApiConstants.constants.API_ADD_FRIEND_FAIL:
      return {
        ...state,
        onLoad: false,
        result: action.error,
    ...
    case ApiConstants.constants.API_ADD_FRIEND_ERROR:
      return {
        ...state,
        onLoad: false,
        error: action.error,
