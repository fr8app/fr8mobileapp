...
function supportReducer(state = initialState, action) {
  switch (action.type) {
    case ApiConstants.constants.API_SUPPORT_LOAD:
      return { ...state, onLoad: true };

    case ApiConstants.constants.API_SUPPORT_SUCCESS:
      return {
        ...state,
        onLoad: false,
    ...
    case ApiConstants.constants.API_SUPPORT_FAIL:
      return {
        ...state,
        onLoad: false,
        result: [],
    ...
    case ApiConstants.constants.API_SUPPORT_UNAUTHENTICATED:
    ...
    case ApiConstants.constants.API_SUPPORT_ERROR:
      return {
        ...state,
        onLoad: false,
        error: action.error,
