...
-(void)deleteCurrentFences
{
    ...
    for (CLCircularRegion *currentRegion in existingArray)
    {
        ...
        NSRange startRange = [currentRegion.identifier rangeOfString:@"%@"];
...
{
    [self deleteGeoFenceWithIdentifier:[NSString stringWithFormat:@"%@", fenceInfo.fenceIDentifier]];
}
...
{
    CLRegion * region ;
    region = [[CLCircularRegion alloc] initWithCenter:center radius:radious identifier:[NSString stringWithFormat:@"%@", identifier]];
