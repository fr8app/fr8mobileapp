...
export default class loginPopUp extends Component {
  ...
  modalClose = () => {
    ...
    this.setState({ userName: "", password: "", text: "" });
  };
  ...
  async getuserName() {
    try {
      let userName = await DataManager.getDummyUserDetails();
      if (userName) {
  ...
  render() {
    console.log(":::::::::modalOpen",this.state.visible)
    return (
      <Modal
          ...
          >
            ...
            >
              <Image
                ...
                resizeMode="contain"
                source={require("../../Images/crossWithborder.png")}
              />
            </TouchableOpacity>
            <Text
              style={{
