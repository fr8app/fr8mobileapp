...
export default class ChangePassword extends Component {
  ...
  modalClose = () => {
    ...
    this.setState({ userName: '', password: '',oldpassword:'',cpassword:'' })
  }
  ...
  setPassword = () => {
     ...
     if (this.state.oldpassword?.trim().length == 0) {
      alert(I18n.t("enter_old_password_alert"))
    }
    // else if (this.state.oldpassword?.trim().length < 6) {
    //   alert(I18n.t("enter_old_password_length_alert"))
    // }
     else if (this.state.password?.trim().length == 0) {
      alert(I18n.t("enter_new_password_alert"))
    }
    else if (this.state.password?.trim().length < 6) {
      alert(I18n.t("enter_new_password_length_alert"))
    }
      ...
      alert(I18n.t("enter_old_cofirm_not_valid_alert"))
    }
    else {
  ...
  otpVerify = () => {
    if (this.state.code == "" || this.state.code?.trim().length == 0) {
      ...
      this.props.verifyOtpForPassword(this.state.code?.trim(), this.state.userName)
    }
  }
            ...
            </Text>
            {
              <>
                ...
                value={this.state.oldpassword}
                    ...
                    placeholder={I18n.t('Enter_Old_Password')} style={{ marginTop: 15, paddingVertical: 15, paddingHorizontal: 10, backgroundColor: '#FFFFFF', borderRadius: 20, width: '85%' }} />
                  ...
                  value={this.state.password}
                    ...
                    placeholder={I18n.t('Enter_New_Password')} style={{ marginTop: 15, paddingVertical: 15, paddingHorizontal: 10, backgroundColor: '#FFFFFF', borderRadius: 20, width: '85%' }} />
                   <TextInput
                   value={this.state.cpassword}
                    ...
                    placeholder={'Enter Confirm New Password'} style={{ marginTop: 15, paddingVertical: 15, paddingHorizontal: 10, backgroundColor: '#FFFFFF', borderRadius: 20, width: '85%' }} />
              

                <TouchableOpacity
                  onPress={() => { this.setPassword() }}
                  style={{ alignSelf: 'center', alignItems: 'center', justifyContent: 'center', width: '85%', paddingVertical: 15, marginTop: 30, borderRadius: 20, justifyContent: 'center', backgroundColor: '#28A2E1' }}>
                  <Text
