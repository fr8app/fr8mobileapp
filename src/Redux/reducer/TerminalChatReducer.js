...
function terminalChat(state = initialState, action) {
  switch (action.type) {
    case ApiConstants.constants.API_TERMINAL_CHAT_LOAD:
    ...
    case ApiConstants.constants.API_TERMINAL_CHAT_FAIL:
      return {
        ...state,
        onLoad: false,
        result: [],
    ...
    case ApiConstants.constants.API_TERMINAL_CHAT_UNAUTHENTICATED:
    ...
    case ApiConstants.constants.API_TERMINAL_CHAT_ERROR:
      return {
        ...state,
        onLoad: false,
        error: action.error,
